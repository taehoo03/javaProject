...
public class StringEquals {
	...
	public static void main(java.lang.String[] args) {
		//String 클래스 참조변수 선언및 인스턴스 생성 방법
		//"문자열" 대입
		//String 클래스는 문자열이 저장되는 변수 1개가 있음 저장 문자열이 동일하면 기존 객체를 사용
		String strVar1="신민수";
		String strVar2 ="신민수";
		 //참조 변수에 대한 == 연산은 참조주소가 같은지 확인
		
		if(strVar1 ==strVar2) {//참조변수가 저장하고 있는 주소가 같으지를 확인
			System.out.println("strVar1과 strVar2 는 참조가 같음");
		}else {
			System.out.println("strVar1과 strVar2 는 참조가 다름");
		}
		
		//참조되는 데이터(문자열)이 같은지확인하기 위해서는 String class 가 제공하는 메소드 equals() 사용
		...
		if(strVar3 ==strVar4) {//참조변수가 저장하고 있는 주소가 같으지를 확인
			System.out.println("strVar1과 strVar2 는 참조가 같음");
		}else {
			System.out.println("strVar1과 strVar2 는 참조가 다름");
		}
