...
public class Switch {
   ...
   public static void main(String[] args) {
      ...
      year = sc.nextInt(); //입력된 문자를 정수로 변환 수 반환(입력 완료인 enter 문자는 처리하지 않음)
     ...
     //값이 문자열인 경우 예제
      ...
      String position =sc.nextLine();//nextLine()은 공백을 포함한 문자열을 입력받는다(enter 문자도 포함됨)
      ...
      case 'C':
      case'D':
    	  System.out.println("노력 필요"); break;
